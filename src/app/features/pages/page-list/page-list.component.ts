    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-header__subtitle">
          Manage application pages and navigation routes
        </p>
      </div>
    ...
    <mat-card>
      ...
      <table mat-table [dataSource]="pages()" class="w-full">
        ...
        <ng-container matColumnDef="route_path">
          <th mat-header-cell *matHeaderCellDef>route_path</th>
          <td mat-cell *matCellDef="let p">
            <code class="mono">{{ p.route_path }}</code>
          </td>
        </ng-container>
            ...
            <div class="action-btns">
              ...
              <ng-container *appHasPermission="'pages.delete'">
                @if (!p.is_system) {
                  ...
                  <mat-icon
                    matTooltip="System page — cannot be deleted"
                    style="color:var(--text-secondary);opacity:.4;padding:6px"
                  >
                    lock
                  </mat-icon>
                }
...
export class PageListComponent implements OnInit {
  ...
  columns = ['sort_order', 'name', 'route_path', 'is_active', 'actions'];
  pages = signal<Page[]>([]);
  total = signal(0);
